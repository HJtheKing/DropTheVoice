      ...
      <v-row justify="center">
        <v-col cols="12" sm="8" md="6">
          <v-tabs v-model="activeTab" centered background-color="primary" class="mb-4">
            <v-tab value="all" @click="store.changeTab(activeTab)">줍한 음성 목록</v-tab>
            <v-tab value="liked" @click="store.changeTab(activeTab)">좋아요 음성 목록</v-tab>
            <v-tab value="alarm">전파된 음성 목록</v-tab>
          </v-tabs>
        </v-col>
      </v-row>
